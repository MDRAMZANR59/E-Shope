<footer id="footer" class="overflow-hidden">
          ...
          <div class="col-md-4 col-sm-6">
            <div class="Shipping d-flex">
              ...
              <div class="card-wrap ps-2">
                <img src="<?= get_template_directory_uri()?>/images/dhl.png" alt="visa">
                <img src="<?= get_template_directory_uri() ?>/images/shippingcard.png" alt="mastercard">
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="payment-method d-flex">
              <p>Payment options:</p>
              <div class="card-wrap ps-2">
                <img src="<?= get_template_directory_uri() ?>/images/visa.jpg" alt="visa">
                <img src="<?= get_template_directory_uri() ?>/images/mastercard.jpg" alt="mastercard">
                <img src="<?= get_template_directory_uri() ?>/images/paypal.jpg" alt="paypal">
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
    ...
    <script src="<?= get_template_directory_uri() ?>/js/jquery-1.11.0.min.js"></script>
